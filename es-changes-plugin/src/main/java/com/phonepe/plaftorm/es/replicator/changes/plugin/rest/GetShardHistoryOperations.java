...
@Slf4j
public class GetShardHistoryOperations extends BaseRestHandler {
    public GetShardHistoryOperations(final Settings settings, final RestController controller) {
        super(settings);
    ...
    public String getName() {
        return GetShardHistoryOperations.class.getName();
    }
